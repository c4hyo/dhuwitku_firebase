...
class MoneyAddScreen extends StatefulWidget {
  ...
  const MoneyAddScreen({Key key, this.user, this.isAdmin, this.userModel})
      : super(key: key);

  @override
  _MoneyAddScreenState createState() => _MoneyAddScreenState();
}
